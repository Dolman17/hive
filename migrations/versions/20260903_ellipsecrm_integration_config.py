"""Bind Ellipse CRM to the HIVE marketplace.

Revision ID: 20260903_ellipsecrm_config
Revises: 20260903_pathlyhire_config
...
revision = "20260903_ellipsecrm_config"
down_revision = "20260903_pathlyhire_config"
branch_labels = None
depends_on = None


APP_SLUG = "ellipse-crm"
APP_NAME = "Ellipse CRM"
SERVICE_KEY = "ellipsecrm"
BASE_URL = "https://ellipse-crm-web-production.up.railway.app"
LAUNCH_URL = "/integrations/apps/ellipse-crm/launch"
    ...
    return connection.execute(
        sa.text(
            ...
            INSERT INTO app_module (
                ...
                :name,
                :slug,
                'Client and HR case management for independent HR consultants.',
                'professional',
                NULL,
                NULL,
                TRUE,
